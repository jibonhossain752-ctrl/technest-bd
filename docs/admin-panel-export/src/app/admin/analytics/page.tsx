// EXPORT NOTE: backend imports removed: '@/lib/admin-auth' (guard) and '@/lib/analytics-queries' (getTopProducts, getTopCategories, getTopBlogPosts, getSourceRankings, getFunnel, getDailyTrend, getTopPages, getSearchRankings, getFaqExpandRanking, getNewsletterStats, getMissingAnalyticsDays).
// The local getReports() below queries Supabase 'analytics_reports' directly — backend code, re-implement.
