// EXPORT NOTE: backend imports removed: '@/lib/admin-auth' (guard) and '@/lib/analytics-queries' (getLocationAnalytics, getMissingAnalyticsDays).
import type { Metadata } from 'next'
import { redirect } from 'next/navigation'
import { cookies } from 'next/headers'
import Link from 'next/link'
import { ADMIN_COOKIE, verifySessionToken } from '@/lib/admin-auth'
import { getLocationAnalytics, getMissingAnalyticsDays } from '@/lib/analytics-queries'
import AnalyticsNav from '../AnalyticsNav'
import ExportButtons from '../ExportButtons'
import AnalyticsBackfill from '../AnalyticsBackfill'

export const runtime = 'nodejs'
export const metadata: Metadata = { title: 'Location Analytics — Admin' }
...
export default async function LocationsPage({
  ...
  try {
    ;[locations, missingDays] = await Promise.all([
