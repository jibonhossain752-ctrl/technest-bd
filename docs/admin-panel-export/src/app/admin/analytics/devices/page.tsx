// EXPORT NOTE: backend imports removed: '@/lib/admin-auth' (guard) and '@/lib/analytics-queries' (getDeviceAnalytics, getMissingAnalyticsDays).
...
export const metadata: Metadata = { title: 'Device Analytics — Admin' }
