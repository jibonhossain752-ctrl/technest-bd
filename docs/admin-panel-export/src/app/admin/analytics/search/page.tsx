// EXPORT NOTE: backend imports removed: '@/lib/admin-auth' (guard) and '@/lib/analytics-queries' (getSearchRankings, getSearchClickRank, getFaqExpandRanking, getFaqGoogleTraffic, getSearchEngineTraffic, getMissingAnalyticsDays).
...
export const metadata: Metadata = { title: 'Search & FAQ Analytics — Admin' }
